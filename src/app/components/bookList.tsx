    ...
    return (
        <>
            ...
            <Box className="h-full">
                ...
                <Box className="grid grid-rows-[repeat(auto-fill,_minmax(350px,_1fr))] grid-cols-[repeat(auto-fit,_minmax(260px,_1fr))] xl:grid-cols-[repeat(auto-fill,_minmax(360px,_1fr))] gap-4 p-8 overflow-y-auto items-center justify-items-center md:justify-items-start h-[calc(100%-90px)]">
